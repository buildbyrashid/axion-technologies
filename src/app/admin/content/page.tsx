    ...
    <div className="w-full space-y-10 pb-24">
      ...
      <div className="sticky top-0 z-30 bg-[#F8FAFC]/90 backdrop-blur-md py-6 border-b border-slate-200/60 -mx-10 lg:-mx-14 px-10 lg:px-14 flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-extrabold text-[#0A1628] dark:text-white tracking-tighter">Homepage CMS</h1>
        </div>
        ...
        <button
          ...
          className={cn(
            ...
            activeTab === 'hero' 
              ...
              : "border-transparent text-slate-400 dark:text-slate-300 hover:text-slate-600 dark:text-slate-300"
          )}
        >
      ...
      <div className="space-y-10">
        <AnimatePresence mode="wait">
          {activeTab === 'hero' && (
            ...
            >
              {/* Headline Card */}
              <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-black/5 dark:border-white/10 p-10 shadow-sm space-y-8 relative overflow-hidden">
                <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                  <div className="w-12 h-12 rounded-2xl bg-[#0D95F0]/10 text-[#0D95F0] flex items-center justify-center">
                    <Type size={22} />
                  </div>
                  <div>
                    <h3 className="text-xl font-extrabold text-[#0A1628] dark:text-white tracking-tight">Main Headline Parameters</h3>
                    <p className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Entry visuals identity</p>
                  </div>
                </div>

                <div className="space-y-6">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Signature Headline</label>
                    <input
                      value={hero.headline}
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Subheadline context</label>
                    <textarea
                      value={hero.subheadline}
                      onChange={e => setHero({ ...hero, subheadline: e.target.value })}
                      rows={4}
                      className="w-full px-6 py-4 rounded-2xl border border-slate-200 dark:border-slate-800 focus:ring-4 focus:ring-[#0D95F0]/5 focus:border-[#0D95F0]/20 outline-none text-sm font-bold tracking-tight transition-all resize-none leading-relaxed"
              ...
              <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-black/5 dark:border-white/10 p-10 shadow-sm space-y-8">
                <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                  ...
                  <div>
                    <h3 className="text-xl font-extrabold text-[#0A1628] dark:text-white tracking-tight">Media Presentation Protocols</h3>
                    <p className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Video & Image controls</p>
                  </div>
                </div>

                {/* Primary Mode Picker */}
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Primary Display Protocol</label>
                  <div className="flex max-w-md p-1.5 bg-slate-100 dark:bg-slate-800 rounded-2xl">
                    {['video', 'image'].map(type => (
                      <button 
                        ...
                        className={cn(
                          ...
                          hero.hero_type === type 
                            ? "bg-white dark:bg-slate-900 text-[#0A1628] dark:text-white shadow-sm" 
                            : "text-slate-400 dark:text-slate-300 hover:text-slate-600 dark:text-slate-300"
                        )}
                      >
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-slate-300 font-semibold italic ml-1">
                ...
                <div className="space-y-10 pt-4">
                  <h4 className="text-xs font-black uppercase tracking-wider text-slate-600 dark:text-slate-300 border-l-4 border-[#0D95F0] pl-3">Video Resources</h4>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Video 1 */}
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Hero Video 1 URL / Asset</label>
                      ...
                      {hero.hero_video_1 && (
                        <div className="relative aspect-[16/9] rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-950 group">
                          <video
                    ...
                    {/* Video 2 */}
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Hero Video 2 URL / Asset (Optional)</label>
                      <div className="flex gap-2">
                        <input
                  ...
                  <div className="space-y-3 max-w-md">
                    <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Active Background Video Selection</label>
                    <select
                      value={hero.active_video}
                      onChange={e => setHero({ ...hero, active_video: e.target.value })}
                      className="w-full px-5 py-3 text-xs font-bold border border-slate-200 dark:border-slate-800 rounded-xl outline-none bg-slate-50 dark:bg-slate-800 cursor-pointer"
                    >
                ...
                <div className="space-y-10 pt-10 border-t border-slate-100">
                  <h4 className="text-xs font-black uppercase tracking-wider text-slate-600 dark:text-slate-300 border-l-4 border-amber-500 pl-3">Image Resources</h4>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Image 1 */}
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Hero Image 1 URL</label>
                      <div className="flex gap-2">
                        <input
                      ...
                      {/* Image 1 Preview */}
                      {hero.hero_image_1 && (
                        <div className="relative aspect-[16/9] rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-950">
                          <img
                    ...
                    {/* Image 2 */}
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Hero Image 2 URL (Optional)</label>
                      <div className="flex gap-2">
                        <input
                    ...
                    {/* Fallback Image */}
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Fallback Poster Image URL</label>
                      <div className="flex gap-2">
                        <input
                    ...
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Active Background Image Selection</label>
                      <select
                        value={hero.active_image}
                        onChange={e => setHero({ ...hero, active_image: e.target.value })}
                        className="w-full px-5 py-3.5 text-xs font-bold border border-slate-200 dark:border-slate-800 rounded-xl outline-none bg-slate-50 dark:bg-slate-800 cursor-pointer"
                      >
            ...
            >
              ...
              <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-black/5 dark:border-white/10 p-10 shadow-sm space-y-8">
                <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                  ...
                  <div>
                    <h3 className="text-xl font-extrabold text-[#0A1628] dark:text-white tracking-tight">Expertise Section Headlines</h3>
                    <p className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Section Header Texts</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Section Label</label>
                    <input
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Section Title</label>
                    <input
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Section Description</label>
                  <textarea
              ...
              <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-black/5 dark:border-white/10 p-10 shadow-sm space-y-8">
                <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                  ...
                  <div>
                    <h3 className="text-xl font-extrabold text-[#0A1628] dark:text-white tracking-tight">Authority Statistics</h3>
                    <p className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">4 Key Corporate Milestones</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {/* Stat 1 */}
                  <div className="p-6 bg-slate-50 dark:bg-slate-800 border border-slate-100 rounded-2xl space-y-4">
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-[#0D95F0]">Statistic Milestone 1</h4>
                    <div className="space-y-3">
                      <label className="text-[9px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Number / Value</label>
                      <input
                        value={expertise.stat_1_number}
                        onChange={e => setExpertise({ ...expertise, stat_1_number: e.target.value })}
                        className="w-full px-4 py-2.5 text-xs font-bold border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 outline-none"
                        placeholder="2006"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[9px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Label</label>
                      <input
                ...
                <p className="text-[10px] font-semibold text-slate-400 dark:text-slate-300 italic text-center pt-2">
            ...
            >
              <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-black/5 dark:border-white/10 p-10 shadow-sm space-y-8">
                <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                  ...
                  <div>
                    <h3 className="text-xl font-extrabold text-[#0A1628] dark:text-white tracking-tight">Our Products Configuration</h3>
                    <p className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest">Update products displayed on homepage</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {products.map((product, index) => (
                    <div key={product.id || index} className="p-6 border border-slate-200 dark:border-slate-800 rounded-2xl space-y-5 bg-slate-50/50 dark:bg-slate-800/50">
                      <div className="flex items-center justify-between">
                        <h4 className="text-xs font-black uppercase tracking-wider text-[#0A1628] dark:text-white">Product Card {index + 1}</h4>
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-300">Order: {product.sort_order}</span>
                      </div>

                      <div className="space-y-3">
                        <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Card Title</label>
                        <input
                          value={product.title}
                          onChange={e => {
                            const next = [...products]
                          ...
                          className="w-full px-5 py-3 rounded-xl border border-slate-200 dark:border-slate-800 focus:ring-4 focus:ring-[#0D95F0]/5 focus:border-[#0D95F0]/20 outline-none text-sm font-bold tracking-tight transition-all"
                          placeholder="e.g. LED Display Systems"
                        />
                      </div>

                      <div className="space-y-3">
                        <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Category Label</label>
                        <input
                      ...
                      <div className="space-y-3">
                        <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest ml-1">Image URL / Asset</label>
                        <div className="flex gap-2">
                          <input
                            value={product.image}
                            onChange={e => {
                        ...
                        {product.image && (
                          <div className="relative aspect-[4/3] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden mt-3">
                            <img
                              src={product.image}
                              alt="Product Preview"
