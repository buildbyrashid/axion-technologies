      ...
      <div id="contact-form-section" className="container-custom py-20 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 xl:gap-20">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 md:p-14 border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)]">
              <div className="mb-10">
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <a href="mailto:sales@axiontechnology.com" className="group p-8 bg-white border border-slate-100 hover:border-accent hover:shadow-xl hover:shadow-accent/5 transition-all duration-500">
                <div className="h-12 w-12 bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent transition-colors duration-500">
              ...
              <div className="group p-8 bg-white border border-slate-100 hover:shadow-xl transition-all duration-500">
                <div className="h-12 w-12 bg-slate-50 flex items-center justify-center mb-6">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-5">
                {offices.map((o) => (
                  <div key={o.city} className="flex items-center p-6 bg-white border border-slate-100 hover:border-slate-200 hover:shadow-lg transition-all duration-500 group">
                    <div className="text-3xl mr-6 h-16 w-16 flex items-center justify-center bg-slate-50 grayscale group-hover:grayscale-0 transition-all duration-700">{o.flag}</div>
