        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="text-left">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-5xl lg:text-7xl font-[800] text-white font-sora leading-[1.1] tracking-tighter mb-8">
                Let's Build the <br />
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <Button size="lg" className="rounded-full bg-accent hover:bg-white hover:text-primary transition-all duration-500 px-10 h-14 text-lg font-bold shadow-[0_0_30px_rgba(13,149,240,0.4)] border-none">
                  Request a Consultation
                  <ArrowUpRight className="ml-2 h-5 w-5" />
                </Button>
                <Button size="lg" variant="outline" className="rounded-full border-white/20 text-white bg-white/5 backdrop-blur-sm hover:bg-white hover:text-primary hover:border-transparent px-10 h-14 text-lg font-bold transition-all duration-500">
                  Contact Our Team
                </Button>
              </div>
            </motion.div>
          ...
          >
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-8 sm:p-12 shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-white mb-10 font-sora">Contact Information</h3>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:sales@axiontechnology.com" className="text-xl text-white hover:text-accent transition-colors font-medium">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.axiontechnology.com" className="text-xl text-white hover:text-accent transition-colors font-medium">
