    ...
    <div className="product-page bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-5">
                <Button className="rounded-full bg-accent hover:bg-white hover:text-accent h-16 px-10 text-lg font-bold group shadow-lg shadow-accent/20 transition-all duration-300">
                  Request Quote <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button variant="outline" className="rounded-full border-white/20 text-white hover:bg-white/10 h-16 px-10 text-lg font-bold transition-all duration-300">
                  Contact Specialist
                </Button>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative aspect-square lg:aspect-auto lg:h-[600px] w-full rounded-3xl overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.6)] border border-white/10"
            >
              <Image 
                src={heroImage} 
                alt={title} 
      ...
      <section className="relative z-20 -mt-10">
        <div className="container-custom">
          <div className="flex flex-wrap justify-center gap-2 p-2 bg-white/90 backdrop-blur-md rounded-full shadow-2xl border border-slate-200/50 max-w-fit mx-auto">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                      <div key={index} className="p-10 bg-white rounded-3xl border border-slate-100 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:border-accent/20 group">
                        <div className="w-16 h-16 rounded-2xl bg-slate-50 flex items-center justify-center text-accent mb-8 group-hover:bg-accent group-hover:text-white transition-colors duration-300">
                ...
                >
                  ...
                  <div className="flex flex-col gap-4">
                    {downloads.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-6 bg-slate-50 rounded-2xl border border-slate-100 transition-all hover:bg-white hover:shadow-xl hover:border-accent/20 group cursor-pointer">
                        <div className="flex items-center gap-6">
                          <div className="w-14 h-14 rounded-xl bg-white flex items-center justify-center text-accent shadow-sm group-hover:bg-accent group-hover:text-white transition-all">
                            <Download size={24} />
                          </div>
                          <div>
                        ...
                        <Button variant="ghost" className="rounded-full text-accent font-bold hover:bg-accent hover:text-white transition-all">
                          Download Now
                        </Button>
                      </div>
                    ))}
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {gallery.map((img, index) => (
                      <div key={index} className="relative aspect-video rounded-3xl overflow-hidden group cursor-pointer">
                        <Image 
                          src={img} 
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                           <Button className="rounded-full bg-white text-primary font-bold hover:bg-accent hover:text-white border-none shadow-xl">
                             View Project
                           </Button>
                        </div>
                      </div>
      ...
      <section className="pb-32">
        <div className="container-custom">
          <div className="relative overflow-hidden bg-primary rounded-[3rem] p-10 lg:p-20 text-white">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-accent/20 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/4 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-1/3 h-1/2 bg-white/5 blur-[80px] rounded-full pointer-events-none" />
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
              <div>
                ...
                <div className="grid grid-cols-1 gap-4 max-w-sm">
                  <a href="https://wa.me/your-number" className="flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-accent transition-all group">
                    <div className="w-12 h-12 rounded-xl bg-accent/20 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all">
                      <MessageSquare size={20} />
                    </div>
                    <span className="font-bold text-lg">WhatsApp Inquiry</span>
                  </a>
                  <a href="mailto:sales@axiontechnology.com" className="flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-accent transition-all group">
                    <div className="w-12 h-12 rounded-xl bg-accent/20 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all">
                      <Mail size={20} />
                    </div>
                    <span className="font-bold text-lg">Email Sales Team</span>
                  </a>
                  <a href="tel:+123456789" className="flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-accent transition-all group">
                    <div className="w-12 h-12 rounded-xl bg-accent/20 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all">
                      <Phone size={20} />
                    </div>
              ...
              <div className="bg-white rounded-[2.5rem] p-10 lg:p-12 shadow-2xl">
                 <form className="space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">First Name</label>
                        <input type="text" className="w-full p-4 rounded-xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-accent focus:bg-white transition-all outline-none text-slate-900 font-medium" />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <input type="email" className="w-full p-4 rounded-xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-accent focus:bg-white transition-all outline-none text-slate-900 font-medium" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Project Details</label>
                      <textarea rows={4} className="w-full p-4 rounded-xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-accent focus:bg-white transition-all outline-none text-slate-900 font-medium resize-none"></textarea>
                    </div>
                    <Button className="w-full h-16 bg-accent text-white font-bold text-xl rounded-2xl hover:scale-[1.02] shadow-xl shadow-accent/20 active:scale-[0.98] transition-all">
